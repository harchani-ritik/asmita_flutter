...
List<SportWidget> sportsList = [
  SportWidget(image: 'aquatics.jpg',
    name: 'Aquatics',
  ),
  SportWidget(image: 'athleticsfield.jpg',
    name: 'Athletics Field Events',
  ),
  SportWidget(image: 'athleticstrack.jpg',
    name: 'Athletics Track Events',
  ),
  SportWidget(image: 'badminton.jpeg',
    name: 'Badminton',
  ),
  SportWidget(image: 'basketball.jpg',
    name: 'Basketball',
  ),
  SportWidget(image: 'carrom.jpg',
    name: 'Carrom',
  ),
  SportWidget(image: 'chess.jpeg',
    name: 'Chess',
  ),
  SportWidget(image: 'cricket.jpg',
    name: 'Cricket',
  ),
  SportWidget(image: 'football.jpg',
    name: 'Football',
  ),
  SportWidget(image: 'lawntennis.jpg',
    name: 'Lawn Tennis',
  ),
  SportWidget(image: 'powerlifting.jpg',
    name: 'Power Lifting',
  ),
  SportWidget(image: 'pubg.jpg',
    name: 'Pubg',
  ),
  SportWidget(image: 'snooker.jpg',
    name: 'Snooker',
  ),
  SportWidget(image: 'squash.jpg',
    name: 'Squash',
  ),
  SportWidget(image: 'tabletennis.jpg',
    name: 'Table Tennis',
  ),
  SportWidget(image: 'volleyball.jpg',
    name: 'Volleyball',
  ),
